...
public final class Validason {
  ...
  private static final byte[] SHARED_HEX_TABLE = buildHexTable();
  ...
  public static boolean isValid(String s) {
    ...
    if (s.length() < THRESHOLD) {
      return PathShort54.isValid(s);
    }
    return PathLong69.isValid(s);
  }

  private static byte[] buildHexTable() {
  ...
  private static final class PathShort54 {
  ...
  private static final class PathShort22 {
    ...
    private static final int INITIAL_STACK_CAP = 16;
  ...
  private static final class PathLong69 {
